...
> While the simulation of the robot is running, open a new terminal and do the  following:
 - A: **Joints**
    ...
    - 3: We can see the actual names of the gripper and the joints by typing in the terminal: 
      ...
      **You can see a basic Python script for controlling the manipulator [here](https://github.com/laloutsos/Custom_Clearpath_Robot/blob/main/Code_Examples/kinova_controller.py).**
  ...
  - B: **Gripper**
      ...
      - 3: Controlling the gripper: Now that we know everything we can send commands to the gripper:
        ...
        **You can find a basic Python script for controlling the gripper [here](https://github.com/laloutsos/Custom_Clearpath_Robot/blob/main/Code_Examples/gripper_controller.py).**
---
