...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/robolab/clearpath/platform/config/imu_filter.yaml',
        description='')
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/robolab/clearpath/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/robolab/clearpath/sensors/config/gps_0.yaml'
                    ,
                }
                ,
            ]
