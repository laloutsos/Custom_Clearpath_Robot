...
#include "clearpath_platform_msgs/msg/detail/pinout_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const clearpath_platform_msgs::msg::PinoutCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  clearpath_platform_msgs::msg::PinoutCommand & ros_message)
{
  // Member: rails
  {
    cdr >> ros_message.rails;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_clearpath_platform_msgs
max_serialized_size_PinoutCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs::msg::PinoutCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_clearpath_platform_msgs
max_serialized_size_key_PinoutCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::msg::PinoutCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<clearpath_platform_msgs::msg::PinoutCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PinoutCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::msg::PinoutCommand *>(
...
static size_t _PinoutCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PinoutCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PinoutCommand__callbacks = {
...
static rosidl_message_type_support_t _PinoutCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PinoutCommand__callbacks,
...
{
  return &clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::_PinoutCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_platform_msgs, msg, PinoutCommand)() {
  return &clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::_PinoutCommand__handle;
}
