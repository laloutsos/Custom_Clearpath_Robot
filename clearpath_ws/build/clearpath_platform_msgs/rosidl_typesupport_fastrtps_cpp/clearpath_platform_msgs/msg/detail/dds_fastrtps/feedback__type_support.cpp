...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_DriveFeedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    for (size_t i = 0; i < 2; i++) {
      clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.drivers[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: drivers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.drivers[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: drivers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_DriveFeedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
