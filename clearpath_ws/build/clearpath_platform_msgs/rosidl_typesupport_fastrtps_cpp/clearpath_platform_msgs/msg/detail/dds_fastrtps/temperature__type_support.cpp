...
#include "clearpath_platform_msgs/msg/detail/temperature__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const clearpath_platform_msgs::msg::Temperature & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  clearpath_platform_msgs::msg::Temperature & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs::msg::Temperature;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::msg::Temperature *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<clearpath_platform_msgs::msg::Temperature *>(
    untyped_ros_message);
...
{
  return &clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::_Temperature__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_platform_msgs, msg, Temperature)() {
  return &clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::_Temperature__handle;
}
