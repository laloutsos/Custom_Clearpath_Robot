  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const clearpath_platform_msgs__msg__DriveFeedback * ros_message = static_cast<const clearpath_platform_msgs__msg__DriveFeedback *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_clearpath_platform_msgs__msg__DriveFeedback(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  clearpath_platform_msgs__msg__DriveFeedback * ros_message = static_cast<clearpath_platform_msgs__msg__DriveFeedback *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_clearpath_platform_msgs__msg__DriveFeedback(cdr, ros_message);
}
