  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const clearpath_platform_msgs__msg__RGB * ros_message = static_cast<const clearpath_platform_msgs__msg__RGB *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_clearpath_platform_msgs__msg__RGB(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  clearpath_platform_msgs__msg__RGB * ros_message = static_cast<clearpath_platform_msgs__msg__RGB *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_clearpath_platform_msgs__msg__RGB(cdr, ros_message);
}
