...
#include "clearpath_platform_msgs/msg/detail/temperature__rosidl_typesupport_fastrtps_c.h"
...
using _Temperature__ros_msg_type = clearpath_platform_msgs__msg__Temperature;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
bool cdr_serialize_clearpath_platform_msgs__msg__Temperature(
  const clearpath_platform_msgs__msg__Temperature * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
bool cdr_deserialize_clearpath_platform_msgs__msg__Temperature(
  eprosima::fastcdr::Cdr & cdr,
  clearpath_platform_msgs__msg__Temperature * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
size_t get_serialized_size_clearpath_platform_msgs__msg__Temperature(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
size_t max_serialized_size_clearpath_platform_msgs__msg__Temperature(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs__msg__Temperature;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
bool cdr_serialize_key_clearpath_platform_msgs__msg__Temperature(
  const clearpath_platform_msgs__msg__Temperature * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
size_t get_serialized_size_key_clearpath_platform_msgs__msg__Temperature(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Temperature__ros_msg_type * ros_message = static_cast<const _Temperature__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
size_t max_serialized_size_key_clearpath_platform_msgs__msg__Temperature(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const clearpath_platform_msgs__msg__Temperature * ros_message = static_cast<const clearpath_platform_msgs__msg__Temperature *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_clearpath_platform_msgs__msg__Temperature(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  clearpath_platform_msgs__msg__Temperature * ros_message = static_cast<clearpath_platform_msgs__msg__Temperature *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_clearpath_platform_msgs__msg__Temperature(cdr, ros_message);
}

static uint32_t _Temperature__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_clearpath_platform_msgs__msg__Temperature(
...
static size_t _Temperature__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_clearpath_platform_msgs__msg__Temperature(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, clearpath_platform_msgs, msg, Temperature)() {
