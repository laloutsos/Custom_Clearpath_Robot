...
enum
{
  clearpath_platform_msgs__srv__ConfigureMcu_Event__request__MAX_SIZE = 1
};
// response
enum
{
  clearpath_platform_msgs__srv__ConfigureMcu_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ConfigureMcu in the package clearpath_platform_msgs.
typedef struct clearpath_platform_msgs__srv__ConfigureMcu_Event
{
  service_msgs__msg__ServiceEventInfo info;
  clearpath_platform_msgs__srv__ConfigureMcu_Request__Sequence request;
  clearpath_platform_msgs__srv__ConfigureMcu_Response__Sequence response;
} clearpath_platform_msgs__srv__ConfigureMcu_Event;

// Struct for a sequence of clearpath_platform_msgs__srv__ConfigureMcu_Event.
typedef struct clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence
{
