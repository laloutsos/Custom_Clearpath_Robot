...
clearpath_platform_msgs__srv__ConfigureMcu_Request__create(void)
{
...
clearpath_platform_msgs__srv__ConfigureMcu_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
clearpath_platform_msgs__srv__ConfigureMcu_Event__init(clearpath_platform_msgs__srv__ConfigureMcu_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    clearpath_platform_msgs__srv__ConfigureMcu_Event__fini(msg);
    return false;
  }
  // request
  if (!clearpath_platform_msgs__srv__ConfigureMcu_Request__Sequence__init(&msg->request, 0)) {
    clearpath_platform_msgs__srv__ConfigureMcu_Event__fini(msg);
    return false;
  }
  // response
  if (!clearpath_platform_msgs__srv__ConfigureMcu_Response__Sequence__init(&msg->response, 0)) {
    clearpath_platform_msgs__srv__ConfigureMcu_Event__fini(msg);
    return false;
  }
  return true;
...
void
clearpath_platform_msgs__srv__ConfigureMcu_Event__fini(clearpath_platform_msgs__srv__ConfigureMcu_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  clearpath_platform_msgs__srv__ConfigureMcu_Request__Sequence__fini(&msg->request);
  // response
  clearpath_platform_msgs__srv__ConfigureMcu_Response__Sequence__fini(&msg->response);
}

bool
clearpath_platform_msgs__srv__ConfigureMcu_Event__are_equal(const clearpath_platform_msgs__srv__ConfigureMcu_Event * lhs, const clearpath_platform_msgs__srv__ConfigureMcu_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!clearpath_platform_msgs__srv__ConfigureMcu_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!clearpath_platform_msgs__srv__ConfigureMcu_Response__Sequence__are_equal(
...
bool
clearpath_platform_msgs__srv__ConfigureMcu_Event__copy(
  const clearpath_platform_msgs__srv__ConfigureMcu_Event * input,
  clearpath_platform_msgs__srv__ConfigureMcu_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!clearpath_platform_msgs__srv__ConfigureMcu_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!clearpath_platform_msgs__srv__ConfigureMcu_Response__Sequence__copy(
...
clearpath_platform_msgs__srv__ConfigureMcu_Event *
clearpath_platform_msgs__srv__ConfigureMcu_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  clearpath_platform_msgs__srv__ConfigureMcu_Event * msg = (clearpath_platform_msgs__srv__ConfigureMcu_Event *)allocator.allocate(sizeof(clearpath_platform_msgs__srv__ConfigureMcu_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(clearpath_platform_msgs__srv__ConfigureMcu_Event));
  bool success = clearpath_platform_msgs__srv__ConfigureMcu_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
clearpath_platform_msgs__srv__ConfigureMcu_Event__destroy(clearpath_platform_msgs__srv__ConfigureMcu_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    clearpath_platform_msgs__srv__ConfigureMcu_Event__fini(msg);
...
bool
clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence__init(clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  clearpath_platform_msgs__srv__ConfigureMcu_Event * data = NULL;

  if (size) {
    data = (clearpath_platform_msgs__srv__ConfigureMcu_Event *)allocator.zero_allocate(size, sizeof(clearpath_platform_msgs__srv__ConfigureMcu_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = clearpath_platform_msgs__srv__ConfigureMcu_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        clearpath_platform_msgs__srv__ConfigureMcu_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence__fini(clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      clearpath_platform_msgs__srv__ConfigureMcu_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence *
clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence * array = (clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence *)allocator.allocate(sizeof(clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence__destroy(clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence__are_equal(const clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence * lhs, const clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!clearpath_platform_msgs__srv__ConfigureMcu_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence__copy(
  const clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence * input,
  clearpath_platform_msgs__srv__ConfigureMcu_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(clearpath_platform_msgs__srv__ConfigureMcu_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    clearpath_platform_msgs__srv__ConfigureMcu_Event * data =
      (clearpath_platform_msgs__srv__ConfigureMcu_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!clearpath_platform_msgs__srv__ConfigureMcu_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          clearpath_platform_msgs__srv__ConfigureMcu_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!clearpath_platform_msgs__srv__ConfigureMcu_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
