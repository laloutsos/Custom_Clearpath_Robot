...
// IWYU pragma: private, include "clearpath_platform_msgs/msg/fans.h"
...
enum
{
  clearpath_platform_msgs__msg__Fans__CC01_FAN1 = 0
};

/// Constant 'CC01_FAN2'.
enum
{
  clearpath_platform_msgs__msg__Fans__CC01_FAN2 = 1
};

/// Constant 'CC01_FAN3'.
enum
{
  clearpath_platform_msgs__msg__Fans__CC01_FAN3 = 2
};

/// Constant 'CC01_FAN4'.
enum
{
  clearpath_platform_msgs__msg__Fans__CC01_FAN4 = 3
};

/// Constant 'CC01_FAN5'.
enum
{
  clearpath_platform_msgs__msg__Fans__CC01_FAN5 = 4
};

/// Constant 'CC01_FAN6'.
enum
{
  clearpath_platform_msgs__msg__Fans__CC01_FAN6 = 5
};

/// Constant 'CC01_FAN7'.
enum
{
  clearpath_platform_msgs__msg__Fans__CC01_FAN7 = 6
};

/// Constant 'CC01_FAN8'.
enum
{
  clearpath_platform_msgs__msg__Fans__CC01_FAN8 = 7
};
