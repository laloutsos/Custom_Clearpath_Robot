...
// IWYU pragma: private, include "clearpath_platform_msgs/msg/lights.h"
...
/// Constant 'A300_LIGHTS_FRONT_RIGHT'.
/**
  * Husky (A300)
 */
enum
{
  clearpath_platform_msgs__msg__Lights__A300_LIGHTS_FRONT_RIGHT = 0
};

/// Constant 'A300_LIGHTS_FRONT_LEFT'.
enum
{
  clearpath_platform_msgs__msg__Lights__A300_LIGHTS_FRONT_LEFT = 1
};

/// Constant 'A300_LIGHTS_REAR_LEFT'.
enum
{
  clearpath_platform_msgs__msg__Lights__A300_LIGHTS_REAR_LEFT = 2
};

/// Constant 'A300_LIGHTS_REAR_RIGHT'.
enum
{
  clearpath_platform_msgs__msg__Lights__A300_LIGHTS_REAR_RIGHT = 3
};
