...
// IWYU pragma: private, include "clearpath_platform_msgs/msg/power.h"
...
/// Constant 'CC01_BATTERY_VOLTAGE'.
/**
  * CC01
 */
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BATTERY_VOLTAGE = 0
};

/// Constant 'CC01_USER_BATTERY_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_USER_BATTERY_VOLTAGE = 1
};

/// Constant 'CC01_USER_24V_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_USER_24V_VOLTAGE = 2
};

/// Constant 'CC01_USER_12VB_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_USER_12VB_VOLTAGE = 3
};

/// Constant 'CC01_SYSTEM_12V_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_SYSTEM_12V_VOLTAGE = 4
};

/// Constant 'CC01_EXPANSION_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_EXPANSION_VOLTAGE = 5
};

/// Constant 'CC01_BREAKOUT_24V_AUX_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_24V_AUX_VOLTAGE = 6
};

/// Constant 'CC01_BREAKOUT_12V_AUX_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_12V_AUX_VOLTAGE = 7
};

/// Constant 'CC01_BREAKOUT_USER_12VA_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_USER_12VA_VOLTAGE = 8
};

/// Constant 'CC01_BREAKOUT_LYNX1_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_LYNX1_VOLTAGE = 9
};

/// Constant 'CC01_BREAKOUT_LYNX2_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_LYNX2_VOLTAGE = 10
};

/// Constant 'CC01_BREAKOUT_LYNX3_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_LYNX3_VOLTAGE = 11
};

/// Constant 'CC01_BREAKOUT_LYNX4_VOLTAGE'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_LYNX4_VOLTAGE = 12
};
...
/// Constant 'CC01_BATTERY_PACK_CURRENT'.
/**
  * CC01
 */
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BATTERY_PACK_CURRENT = 0
};

/// Constant 'CC01_USER_BATTERY_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_USER_BATTERY_CURRENT = 1
};

/// Constant 'CC01_AUX_HES_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_AUX_HES_CURRENT = 2
};

/// Constant 'CC01_SYSTEM_12V_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_SYSTEM_12V_CURRENT = 3
};

/// Constant 'CC01_24V_AUX_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_24V_AUX_CURRENT = 4
};

/// Constant 'CC01_12V_AUX_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_12V_AUX_CURRENT = 5
};

/// Constant 'CC01_BREAKOUT_USER_24V_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_USER_24V_CURRENT = 6
};

/// Constant 'CC01_BREAKOUT_USER_12VA_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_USER_12VA_CURRENT = 7
};

/// Constant 'CC01_BREAKOUT_USER_12VB_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_USER_12VB_CURRENT = 8
};

/// Constant 'CC01_BREAKOUT_USER_LYNX1_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_USER_LYNX1_CURRENT = 9
};

/// Constant 'CC01_BREAKOUT_USER_LYNX2_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_USER_LYNX2_CURRENT = 10
};

/// Constant 'CC01_BREAKOUT_USER_LYNX3_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_USER_LYNX3_CURRENT = 11
};

/// Constant 'CC01_BREAKOUT_USER_LYNX4_CURRENT'.
enum
{
  clearpath_platform_msgs__msg__Power__CC01_BREAKOUT_USER_LYNX4_CURRENT = 12
};
