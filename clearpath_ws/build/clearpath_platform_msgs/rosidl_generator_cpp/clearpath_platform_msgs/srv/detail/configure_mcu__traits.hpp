...
inline std::string to_yaml(const ConfigureMcu_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use clearpath_platform_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const clearpath_platform_msgs::srv::ConfigureMcu_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  clearpath_platform_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use clearpath_platform_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const clearpath_platform_msgs::srv::ConfigureMcu_Event & msg)
{
  return clearpath_platform_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<clearpath_platform_msgs::srv::ConfigureMcu_Event>()
{
  return "clearpath_platform_msgs::srv::ConfigureMcu_Event";
}

template<>
inline const char * name<clearpath_platform_msgs::srv::ConfigureMcu_Event>()
{
  return "clearpath_platform_msgs/srv/ConfigureMcu_Event";
}

template<>
struct has_fixed_size<clearpath_platform_msgs::srv::ConfigureMcu_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<clearpath_platform_msgs::srv::ConfigureMcu_Event>
  : std::integral_constant<bool, has_bounded_size<clearpath_platform_msgs::srv::ConfigureMcu_Request>::value && has_bounded_size<clearpath_platform_msgs::srv::ConfigureMcu_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<clearpath_platform_msgs::srv::ConfigureMcu_Event>
  : std::true_type {};
