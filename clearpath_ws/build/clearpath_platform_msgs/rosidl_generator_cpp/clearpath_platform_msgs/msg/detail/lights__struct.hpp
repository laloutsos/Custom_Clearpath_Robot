...
// IWYU pragma: private, include "clearpath_platform_msgs/msg/lights.hpp"
...
struct Lights_
{
  ...
  static constexpr uint8_t W200_LIGHTS_REAR_RIGHT =
    3u;
  static constexpr uint8_t A300_LIGHTS_FRONT_RIGHT =
    0u;
  static constexpr uint8_t A300_LIGHTS_FRONT_LEFT =
    1u;
  static constexpr uint8_t A300_LIGHTS_REAR_LEFT =
    2u;
  static constexpr uint8_t A300_LIGHTS_REAR_RIGHT =
    3u;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Lights_<ContainerAllocator>::A300_LIGHTS_FRONT_RIGHT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Lights_<ContainerAllocator>::A300_LIGHTS_FRONT_LEFT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Lights_<ContainerAllocator>::A300_LIGHTS_REAR_LEFT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Lights_<ContainerAllocator>::A300_LIGHTS_REAR_RIGHT;
#endif  // __cplusplus < 201703L
