...
// IWYU pragma: private, include "clearpath_platform_msgs/msg/status.hpp"
...
public:
  ...
  : msg_(msg)
  {}
  ::clearpath_platform_msgs::msg::Status connection_uptime(::clearpath_platform_msgs::msg::Status::_connection_uptime_type arg)
  {
