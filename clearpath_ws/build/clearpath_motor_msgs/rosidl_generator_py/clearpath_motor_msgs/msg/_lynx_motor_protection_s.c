...
bool clearpath_motor_msgs__msg__lynx_motor_protection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("clearpath_motor_msgs.msg._lynx_motor_protection.LynxMotorProtection", full_classname_dest, 67) == 0);
  }
  clearpath_motor_msgs__msg__LynxMotorProtection * ros_message = _ros_message;
  {  // can_id
...
{
  /* NOTE(esteve): Call constructor of LynxMotorProtection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("clearpath_motor_msgs.msg._lynx_motor_protection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LynxMotorProtection");
