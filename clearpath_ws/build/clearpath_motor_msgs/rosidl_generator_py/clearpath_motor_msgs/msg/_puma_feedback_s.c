...
bool clearpath_motor_msgs__msg__puma_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("clearpath_motor_msgs.msg._puma_feedback.PumaFeedback", full_classname_dest, 52) == 0);
  }
  clearpath_motor_msgs__msg__PumaFeedback * ros_message = _ros_message;
  {  // device_number
  ...
  {  // travel
    ...
    assert(PyFloat_Check(field));
    ros_message->travel = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // speed
  ...
  {  // setpoint
    ...
    assert(PyFloat_Check(field));
    ros_message->setpoint = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PumaFeedback */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("clearpath_motor_msgs.msg._puma_feedback");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PumaFeedback");
