...
static const _LynxMultiFeedback_type_support_symbol_names_t _LynxMultiFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_motor_msgs, msg, LynxMultiFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, clearpath_motor_msgs, msg, LynxMultiFeedback)),
  }
};
...
{
  return &::clearpath_motor_msgs::msg::rosidl_typesupport_cpp::LynxMultiFeedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, clearpath_motor_msgs, msg, LynxMultiFeedback)() {
  return get_message_type_support_handle<clearpath_motor_msgs::msg::LynxMultiFeedback>();
}
