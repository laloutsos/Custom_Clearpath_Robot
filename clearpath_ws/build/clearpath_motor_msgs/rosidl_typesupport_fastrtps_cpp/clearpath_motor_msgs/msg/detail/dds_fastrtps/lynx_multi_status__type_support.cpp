...
#include "clearpath_motor_msgs/msg/detail/lynx_multi_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const clearpath_motor_msgs::msg::LynxStatus &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const clearpath_motor_msgs::msg::LynxMultiStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  clearpath_motor_msgs::msg::LynxMultiStatus & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_clearpath_motor_msgs
max_serialized_size_LynxMultiStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: drivers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        clearpath_motor_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_LynxStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_motor_msgs::msg::LynxMultiStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_clearpath_motor_msgs
max_serialized_size_key_LynxMultiStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: drivers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        clearpath_motor_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_LynxStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const clearpath_motor_msgs::msg::LynxMultiStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<clearpath_motor_msgs::msg::LynxMultiStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LynxMultiStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const clearpath_motor_msgs::msg::LynxMultiStatus *>(
...
static size_t _LynxMultiStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LynxMultiStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LynxMultiStatus__callbacks = {
...
static rosidl_message_type_support_t _LynxMultiStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LynxMultiStatus__callbacks,
...
{
  return &clearpath_motor_msgs::msg::typesupport_fastrtps_cpp::_LynxMultiStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_motor_msgs, msg, LynxMultiStatus)() {
  return &clearpath_motor_msgs::msg::typesupport_fastrtps_cpp::_LynxMultiStatus__handle;
}
