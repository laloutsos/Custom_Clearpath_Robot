...
#include "clearpath_motor_msgs/msg/detail/lynx_feedback__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const clearpath_motor_msgs::msg::LynxFeedback & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  clearpath_motor_msgs::msg::LynxFeedback & ros_message)
{
  // Member: can_id
  cdr >> ros_message.can_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_motor_msgs::msg::LynxFeedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const clearpath_motor_msgs::msg::LynxFeedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<clearpath_motor_msgs::msg::LynxFeedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LynxFeedback__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const clearpath_motor_msgs::msg::LynxFeedback *>(
...
static size_t _LynxFeedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LynxFeedback(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LynxFeedback__callbacks = {
...
static rosidl_message_type_support_t _LynxFeedback__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LynxFeedback__callbacks,
...
{
  return &clearpath_motor_msgs::msg::typesupport_fastrtps_cpp::_LynxFeedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_motor_msgs, msg, LynxFeedback)() {
  return &clearpath_motor_msgs::msg::typesupport_fastrtps_cpp::_LynxFeedback__handle;
}
