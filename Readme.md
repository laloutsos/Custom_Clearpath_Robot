...
| ● | Driving Jackal via `cmd_vel` | In this section I explain how to control the Jackal robot by publishing velocity commands to the `/j100_000/cmd_vel` topic. | See [folder](/Custom_Jackal_J100_Tutorials/Driving_Jackal.md) for full code and execution examples. |